...
header nav{display:flex;align-items:center;justify-content:space-between;height:100%;max-width:1200px;margin:0 auto;padding:0 24px}
...
.article-card .card-img{height:140px;flex-shrink:0;overflow:hidden}
...
/* ── Ticker ── */
.ticker-wrap{overflow:hidden;background:var(--surface);border-top:1px solid var(--border);border-bottom:1px solid var(--border);padding:12px 0;white-space:nowrap;margin-top:0;margin-bottom:0}
...
// ─── SVG card header images — unique per article slug ───
function cardHeaderSVG(slug, idx) {
  const i = idx || 0;
  const svgs = {

'cheapest-llm-api-pricing': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
<defs><linearGradient id="g-${i}" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#3b82f6"/><stop offset="100%" stop-color="#06b6d4"/></linearGradient><filter id="gl-${i}"><feGaussianBlur stdDeviation="3" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
<rect x="50" y="110" width="40" height="45" rx="3" fill="rgba(59,130,246,.15)" stroke="#3b82f6" stroke-width="1.5"><animate attributeName="height" values="45;55;45" dur="2s" repeatCount="indefinite"/><animate attributeName="y" values="110;100;110" dur="2s" repeatCount="indefinite"/></rect>
<rect x="110" y="85" width="40" height="70" rx="3" fill="rgba(59,130,246,.2)" stroke="#3b82f6" stroke-width="1.5"><animate attributeName="height" values="70;80;70" dur="2.5s" begin=".3s" repeatCount="indefinite"/><animate attributeName="y" values="85;75;85" dur="2.5s" begin=".3s" repeatCount="indefinite"/></rect>
<rect x="170" y="65" width="40" height="90" rx="3" fill="rgba(6,182,212,.2)" stroke="#06b6d4" stroke-width="1.5"><animate attributeName="height" values="90;100;90" dur="3s" begin=".6s" repeatCount="indefinite"/><animate attributeName="y" values="65;55;65" dur="3s" begin=".6s" repeatCount="indefinite"/></rect>
<rect x="230" y="45" width="40" height="110" rx="3" fill="rgba(6,182,212,.25)" stroke="#06b6d4" stroke-width="1.5"><animate attributeName="height" values="110;120;110" dur="2s" begin=".9s" repeatCount="indefinite"/><animate attributeName="y" values="45;35;45" dur="2s" begin=".9s" repeatCount="indefinite"/></rect>
<text x="70" y="105" font-family="Space Mono,monospace" font-size="13" fill="#3b82f6" text-anchor="middle" filter="url(#gl-${i})">$</text>
<text x="130" y="80" font-family="Space Mono,monospace" font-size="13" fill="#3b82f6" text-anchor="middle">$$</text>
<text x="190" y="60" font-family="Space Mono,monospace" font-size="13" fill="#06b6d4" text-anchor="middle">$$$</text>
<text x="250" y="40" font-family="Space Mono,monospace" font-size="11" fill="#06b6d4" text-anchor="middle">$$$$</text>
<text x="340" y="80" font-family="Space Mono,monospace" font-size="28" fill="#3b82f6" text-anchor="middle" opacity=".6" filter="url(#gl-${i})">$<animate attributeName="opacity" values=".6;1;.6" dur="2s" repeatCount="indefinite"/></text>
<text x="360" y="120" font-family="Space Mono,monospace" font-size="20" fill="#06b6d4" text-anchor="middle" opacity=".4"><animate attributeName="opacity" values=".4;.9;.4" dur="2.5s" begin=".7s" repeatCount="indefinite"/>$</text>
<circle cx="330" cy="40" r="3" fill="#3b82f6"><animate attributeName="opacity" values=".3;.8;.3" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="380" cy="140" r="2" fill="#06b6d4"><animate attributeName="opacity" values=".2;.7;.2" dur="3s" begin=".5s" repeatCount="indefinite"/></circle>
<circle cx="20" cy="50" r="2" fill="#3b82f6"><animate attributeName="opacity" values=".3;.6;.3" dur="2.5s" begin="1s" repeatCount="indefinite"/></circle>
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#3b82f6" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#3b82f6" text-anchor="middle" letter-spacing=".08em">LLM API · PRICING · 2026</text>
</svg>`,

'claude-api-vs-openai-api': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
<defs><linearGradient id="g-${i}" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#a855f7"/><stop offset="100%" stop-color="#10b981"/></linearGradient><filter id="gl-${i}"><feGaussianBlur stdDeviation="4" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
<polygon points="110,55 135,70 135,100 110,115 85,100 85,70" fill="rgba(168,85,247,.12)" stroke="#a855f7" stroke-width="2" filter="url(#gl-${i})"><animate attributeName="opacity" values="1;.6;1" dur="3s" repeatCount="indefinite"/></polygon>
<polygon points="290,55 315,70 315,100 290,115 265,100 265,70" fill="rgba(16,185,129,.12)" stroke="#10b981" stroke-width="2" filter="url(#gl-${i})"><animate attributeName="opacity" values="1;.6;1" dur="3s" begin="1s" repeatCount="indefinite"/></polygon>
<text x="110" y="91" font-family="Space Mono,monospace" font-size="9" fill="#a855f7" text-anchor="middle">Claude</text>
<text x="290" y="91" font-family="Space Mono,monospace" font-size="9" fill="#10b981" text-anchor="middle">OpenAI</text>
<line x1="136" y1="85" x2="264" y2="85" stroke="url(#g-${i})" stroke-width="2" stroke-dasharray="6,4"><animate attributeName="stroke-dashoffset" values="0;10" dur="1.2s" repeatCount="indefinite"/></line>
<circle cx="165" cy="85" r="4" fill="#a855f7" opacity=".8"><animate attributeName="cx" values="165;235;165" dur="3s" repeatCount="indefinite"/><animate attributeName="opacity" values=".8;.3;.8" dur="3s" repeatCount="indefinite"/></circle>
<circle cx="235" cy="85" r="3" fill="#10b981" opacity=".6"><animate attributeName="cx" values="235;165;235" dur="3s" begin=".5s" repeatCount="indefinite"/><animate attributeName="opacity" values=".6;.2;.6" dur="3s" begin=".5s" repeatCount="indefinite"/></circle>
<circle cx="60" cy="45" r="2" fill="#a855f7"><animate attributeName="opacity" values=".3;.8;.3" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="340" cy="130" r="2" fill="#10b981"><animate attributeName="opacity" values=".2;.7;.2" dur="2.5s" begin=".8s" repeatCount="indefinite"/></circle>
<circle cx="200" cy="40" r="2" fill="#8b5cf6"><animate attributeName="opacity" values=".3;.6;.3" dur="3s" begin="1.2s" repeatCount="indefinite"/></circle>
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#a855f7" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#a855f7" text-anchor="middle" letter-spacing=".08em">CLAUDE · VS · OPENAI</text>
</svg>`,

'cursor-vs-github-copilot': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
<defs><filter id="gl-${i}"><feGaussianBlur stdDeviation="2" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
<rect x="30" y="35" width="155" height="110" rx="6" fill="rgba(59,130,246,.07)" stroke="#3b82f6" stroke-width="1.5"/>
<rect x="30" y="35" width="155" height="18" rx="6" fill="rgba(59,130,246,.2)"/>
<circle cx="46" cy="44" r="4" fill="#ef4444"/><circle cx="60" cy="44" r="4" fill="#f59e0b"/><circle cx="74" cy="44" r="4" fill="#10b981"/>
<rect x="42" y="65" width="80" height="5" rx="2" fill="#3b82f6" opacity=".5"/>
<rect x="42" y="77" width="60" height="5" rx="2" fill="#06b6d4" opacity=".4"/>
<rect x="42" y="89" width="95" height="5" rx="2" fill="#3b82f6" opacity=".3"/>
<rect x="42" y="101" width="50" height="5" rx="2" fill="#06b6d4" opacity=".35"/>
<rect x="132" y="63" width="2" height="12" rx="1" fill="#3b82f6"><animate attributeName="opacity" values="1;0;1" dur="1s" repeatCount="indefinite"/></rect>
<rect x="215" y="35" width="155" height="110" rx="6" fill="rgba(6,182,212,.07)" stroke="#06b6d4" stroke-width="1.5"/>
<rect x="215" y="35" width="155" height="18" rx="6" fill="rgba(6,182,212,.2)"/>
<circle cx="231" cy="44" r="4" fill="#ef4444"/><circle cx="245" cy="44" r="4" fill="#f59e0b"/><circle cx="259" cy="44" r="4" fill="#10b981"/>
<path d="M270,70 Q285,60 300,70 Q285,80 270,70Z" fill="#06b6d4" opacity=".7"><animate attributeName="opacity" values=".7;1;.7" dur="2s" repeatCount="indefinite"/></path>
<rect x="227" y="87" width="70" height="5" rx="2" fill="#06b6d4" opacity=".45"/>
<rect x="227" y="99" width="90" height="5" rx="2" fill="#3b82f6" opacity=".35"/>
<rect x="227" y="111" width="55" height="5" rx="2" fill="#06b6d4" opacity=".3"/>
<circle cx="20" cy="150" r="2" fill="#3b82f6"><animate attributeName="opacity" values=".3;.8;.3" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="380" cy="30" r="2" fill="#06b6d4"><animate attributeName="opacity" values=".2;.7;.2" dur="3s" begin=".5s" repeatCount="indefinite"/></circle>
<circle cx="200" cy="155" r="2" fill="#8b5cf6"><animate attributeName="opacity" values=".3;.6;.3" dur="2.5s" begin="1s" repeatCount="indefinite"/></circle>
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#3b82f6" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#3b82f6" text-anchor="middle" letter-spacing=".08em">CURSOR · VS · COPILOT</text>
</svg>`,

'deepseek-vs-openai-api': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
<defs><linearGradient id="g-${i}" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stop-color="#ef4444"/><stop offset="100%" stop-color="#10b981"/></linearGradient><filter id="gl-${i}"><feGaussianBlur stdDeviation="4" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
<circle cx="100" cy="85" r="38" fill="rgba(239,68,68,.1)" stroke="#ef4444" stroke-width="2" filter="url(#gl-${i})"><animate attributeName="r" values="38;42;38" dur="2.5s" repeatCount="indefinite"/></circle>
<text x="100" y="80" font-family="Space Mono,monospace" font-size="8" fill="#ef4444" text-anchor="middle">DeepSeek</text>
<text x="100" y="93" font-family="Space Mono,monospace" font-size="7" fill="#ef4444" text-anchor="middle" opacity=".7">🇨🇳 R1</text>
<circle cx="300" cy="85" r="38" fill="rgba(16,185,129,.1)" stroke="#10b981" stroke-width="2" filter="url(#gl-${i})"><animate attributeName="r" values="38;42;38" dur="2.5s" begin="1s" repeatCount="indefinite"/></circle>
<text x="300" y="80" font-family="Space Mono,monospace" font-size="8" fill="#10b981" text-anchor="middle">OpenAI</text>
<text x="300" y="93" font-family="Space Mono,monospace" font-size="7" fill="#10b981" text-anchor="middle" opacity=".7">GPT-4o</text>
<line x1="140" y1="85" x2="260" y2="85" stroke="url(#g-${i})" stroke-width="2" stroke-dasharray="5,3"><animate attributeName="stroke-dashoffset" values="0;8" dur="0.8s" repeatCount="indefinite"/></line>
<text x="165" y="78" font-family="Space Mono,monospace" font-size="7" fill="#ef4444" opacity=".7">01</text>
<text x="185" y="90" font-family="Space Mono,monospace" font-size="7" fill="#10b981" opacity=".7">10</text>
<text x="205" y="78" font-family="Space Mono,monospace" font-size="7" fill="#ef4444" opacity=".6">11</text>
<text x="225" y="90" font-family="Space Mono,monospace" font-size="7" fill="#10b981" opacity=".5">00</text>
<circle cx="30" cy="40" r="2" fill="#ef4444"><animate attributeName="opacity" values=".3;.8;.3" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="370" cy="140" r="2" fill="#10b981"><animate attributeName="opacity" values=".2;.7;.2" dur="2.5s" begin=".6s" repeatCount="indefinite"/></circle>
<circle cx="200" cy="30" r="3" fill="#f59e0b"><animate attributeName="opacity" values=".3;.7;.3" dur="3s" begin="1s" repeatCount="indefinite"/></circle>
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#ef4444" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#ef4444" text-anchor="middle" letter-spacing=".08em">DEEPSEEK · VS · OPENAI</text>
</svg>`,

'chatgpt-vs-claude': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
...
<rect x="40" y="40" width="140" height="90" rx="14" fill="rgba(16,185,129,.1)" stroke="#10b981" stroke-width="2" filter="url(#gl-${i})"/>
<polygon points="54,130 40,148 80,130" fill="#10b981" opacity=".5"/>
<text x="110" y="82" font-family="Space Mono,monospace" font-size="9" fill="#10b981" text-anchor="middle">ChatGPT</text>
<circle cx="88" cy="100" r="5" fill="#10b981" opacity=".7"><animate attributeName="opacity" values=".7;.2;.7" dur="1.2s" repeatCount="indefinite"/></circle>
<circle cx="108" cy="100" r="5" fill="#10b981" opacity=".5"><animate attributeName="opacity" values=".5;.9;.5" dur="1.2s" begin=".3s" repeatCount="indefinite"/></circle>
<circle cx="128" cy="100" r="5" fill="#10b981" opacity=".3"><animate attributeName="opacity" values=".3;.8;.3" dur="1.2s" begin=".6s" repeatCount="indefinite"/></circle>
<rect x="220" y="40" width="140" height="90" rx="14" fill="rgba(168,85,247,.1)" stroke="#a855f7" stroke-width="2" filter="url(#gl-${i})"/>
<polygon points="346,130 360,148 320,130" fill="#a855f7" opacity=".5"/>
<text x="290" y="82" font-family="Space Mono,monospace" font-size="9" fill="#a855f7" text-anchor="middle">Claude</text>
<circle cx="268" cy="100" r="5" fill="#a855f7" opacity=".3"><animate attributeName="opacity" values=".3;.8;.3" dur="1.4s" repeatCount="indefinite"/></circle>
<circle cx="288" cy="100" r="5" fill="#a855f7" opacity=".5"><animate attributeName="opacity" values=".5;.2;.5" dur="1.4s" begin=".35s" repeatCount="indefinite"/></circle>
<circle cx="308" cy="100" r="5" fill="#a855f7" opacity=".7"><animate attributeName="opacity" values=".7;.3;.7" dur="1.4s" begin=".7s" repeatCount="indefinite"/></circle>
<text x="200" y="90" font-family="Space Mono,monospace" font-size="11" fill="#64748b" text-anchor="middle">VS</text>
<circle cx="20" cy="60" r="2" fill="#10b981"><animate attributeName="opacity" values=".3;.8;.3" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="380" cy="50" r="2" fill="#a855f7"><animate attributeName="opacity" values=".2;.7;.2" dur="2.5s" begin=".7s" repeatCount="indefinite"/></circle>
<circle cx="200" cy="155" r="2" fill="#8b5cf6"><animate attributeName="opacity" values=".3;.6;.3" dur="3s" begin="1s" repeatCount="indefinite"/></circle>
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#10b981" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#10b981" text-anchor="middle" letter-spacing=".08em">CHATGPT · VS · CLAUDE</text>
</svg>`,

'dalle-vs-midjourney': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
<defs><linearGradient id="g-${i}" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#3b82f6"/><stop offset="100%" stop-color="#8b5cf6"/></linearGradient><filter id="gl-${i}"><feGaussianBlur stdDeviation="3" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
<rect x="35" y="30" width="150" height="110" rx="8" fill="rgba(59,130,246,.08)" stroke="#3b82f6" stroke-width="1.5"/>
<text x="110" y="48" font-family="Space Mono,monospace" font-size="7" fill="#3b82f6" text-anchor="middle">DALL·E</text>
<polygon points="110,70 125,95 95,95" fill="none" stroke="#3b82f6" stroke-width="1.5"><animate attributeName="points" values="110,70 125,95 95,95;110,65 130,97 90,97;110,70 125,95 95,95" dur="3s" repeatCount="indefinite"/></polygon>
<circle cx="110" cy="80" r="8" fill="rgba(59,130,246,.2)" stroke="#3b82f6" stroke-width="1"><animate attributeName="r" values="8;12;8" dur="3s" repeatCount="indefinite"/></circle>
<text x="35" y="125" font-family="Space Mono,monospace" font-size="6" fill="#3b82f6" opacity=".5">✦</text><text x="170" y="55" font-family="Space Mono,monospace" font-size="8" fill="#3b82f6" opacity=".4">✦</text>
<rect x="215" y="30" width="150" height="110" rx="8" fill="rgba(139,92,246,.08)" stroke="#8b5cf6" stroke-width="1.5"/>
<text x="290" y="48" font-family="Space Mono,monospace" font-size="7" fill="#8b5cf6" text-anchor="middle">Midjourney</text>
<path d="M260,100 Q275,60 290,75 Q305,90 320,55 L325,100" fill="none" stroke="#8b5cf6" stroke-width="2" stroke-dasharray="200"><animate attributeName="stroke-dashoffset" values="200;0" dur="3s" repeatCount="indefinite"/></path>
<circle cx="355" cy="50" r="3" fill="#a78bfa" opacity=".5"><animate attributeName="opacity" values=".5;1;.5" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="230" cy="120" r="2" fill="#8b5cf6" opacity=".4"><animate attributeName="opacity" values=".4;.8;.4" dur="2.5s" begin=".5s" repeatCount="indefinite"/></circle>
<circle cx="20" cy="80" r="2" fill="#3b82f6"><animate attributeName="opacity" values=".3;.7;.3" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="380" cy="155" r="2" fill="#8b5cf6"><animate attributeName="opacity" values=".2;.6;.2" dur="3s" begin="1s" repeatCount="indefinite"/></circle>
<circle cx="200" cy="20" r="2" fill="#a78bfa"><animate attributeName="opacity" values=".3;.8;.3" dur="2.5s" begin=".8s" repeatCount="indefinite"/></circle>
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#8b5cf6" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#8b5cf6" text-anchor="middle" letter-spacing=".08em">DALL-E · VS · MIDJOURNEY</text>
</svg>`,

'clickup-vs-notion': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
<defs><filter id="gl-${i}"><feGaussianBlur stdDeviation="2" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
<rect x="30" y="30" width="160" height="115" rx="6" fill="rgba(59,130,246,.07)" stroke="#3b82f6" stroke-width="1.5"/>
<text x="110" y="50" font-family="Space Mono,monospace" font-size="7" fill="#3b82f6" text-anchor="middle">ClickUp</text>
<rect x="45" y="58" width="12" height="12" rx="2" fill="none" stroke="#3b82f6" stroke-width="1.5"/>
<polyline points="47,64 50,67 55,61" fill="none" stroke="#10b981" stroke-width="1.5"><animate attributeName="opacity" values="0;1;1" dur="2s" repeatCount="indefinite"/></polyline>
<rect x="45" y="76" width="12" height="12" rx="2" fill="none" stroke="#3b82f6" stroke-width="1.5"/>
<polyline points="47,82 50,85 55,79" fill="none" stroke="#10b981" stroke-width="1.5"><animate attributeName="opacity" values="0;0;1" dur="2.5s" begin=".5s" repeatCount="indefinite"/></polyline>
<rect x="45" y="94" width="12" height="12" rx="2" fill="none" stroke="#3b82f6" stroke-width="1.5"/>
<rect x="65" y="61" width="80" height="6" rx="2" fill="#3b82f6" opacity=".4"/>
<rect x="65" y="79" width="60" height="6" rx="2" fill="#3b82f6" opacity=".3"/>
<rect x="65" y="97" width="70" height="6" rx="2" fill="#3b82f6" opacity=".25"/>
<rect x="45" y="115" width="120" height="6" rx="2" fill="#06b6d4" opacity=".3"><animate attributeName="width" values="40;120;120" dur="3s" repeatCount="indefinite"/></rect>
<rect x="210" y="30" width="160" height="115" rx="6" fill="rgba(100,116,139,.07)" stroke="#64748b" stroke-width="1.5"/>
<text x="290" y="50" font-family="Space Mono,monospace" font-size="7" fill="#94a3b8" text-anchor="middle">Notion</text>
<rect x="225" y="60" width="130" height="1.5" fill="#64748b" opacity=".5"/>
<rect x="225" y="72" width="105" height="6" rx="2" fill="#64748b" opacity=".3"/>
<rect x="225" y="84" width="85" height="6" rx="2" fill="#64748b" opacity=".25"/>
<rect x="225" y="96" width="115" height="6" rx="2" fill="#64748b" opacity=".2"/>
<rect x="225" y="108" width="70" height="6" rx="2" fill="#64748b" opacity=".3"/>
<circle cx="295" cy="125" r="6" fill="none" stroke="#94a3b8" stroke-width="1.5"><animate attributeName="r" values="6;8;6" dur="2s" repeatCount="indefinite"/></circle>
<text x="295" y="129" font-family="Space Mono,monospace" font-size="7" fill="#94a3b8" text-anchor="middle">N</text>
<circle cx="20" cy="155" r="2" fill="#3b82f6"><animate attributeName="opacity" values=".3;.8;.3" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="385" cy="20" r="2" fill="#64748b"><animate attributeName="opacity" values=".2;.6;.2" dur="3s" begin=".7s" repeatCount="indefinite"/></circle>
<circle cx="200" cy="150" r="2" fill="#8b5cf6"><animate attributeName="opacity" values=".3;.6;.3" dur="2.5s" begin="1s" repeatCount="indefinite"/></circle>
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#3b82f6" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#3b82f6" text-anchor="middle" letter-spacing=".08em">CLICKUP · VS · NOTION</text>
</svg>`,

'ai-image-generators-2026': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
<defs><linearGradient id="g-${i}" x1="0%" y1="100%" x2="100%" y2="0%"><stop offset="0%" stop-color="#10b981"/><stop offset="100%" stop-color="#34d399"/></linearGradient><filter id="gl-${i}"><feGaussianBlur stdDeviation="3" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
<rect x="80" y="30" width="240" height="105" rx="8" fill="rgba(16,185,129,.06)" stroke="#10b981" stroke-width="1.5" filter="url(#gl-${i})"/>
<circle cx="130" cy="62" r="12" fill="rgba(16,185,129,.15)" stroke="#10b981" stroke-width="1"/>
<polyline points="80,120 130,85 175,100 220,60 270,75 320,40" fill="none" stroke="url(#g-${i})" stroke-width="2" stroke-dasharray="300"><animate attributeName="stroke-dashoffset" values="300;0" dur="3s" repeatCount="indefinite"/></polyline>
<circle cx="220" cy="60" r="4" fill="#10b981"><animate attributeName="r" values="4;7;4" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="320" cy="40" r="4" fill="#34d399"><animate attributeName="r" values="4;7;4" dur="2s" begin=".5s" repeatCount="indefinite"/></circle>
<text x="310" y="75" font-family="Space Mono,monospace" font-size="8" fill="#34d399" opacity=".6">✦</text>
<text x="165" y="50" font-family="Space Mono,monospace" font-size="8" fill="#10b981" opacity=".5">✦</text>
<text x="90" y="45" font-family="Space Mono,monospace" font-size="6" fill="#34d399" opacity=".4">✦</text>
<circle cx="25" cy="60" r="3" fill="#10b981" opacity=".5"><animate attributeName="cy" values="60;50;60" dur="3s" repeatCount="indefinite"/><animate attributeName="opacity" values=".5;.9;.5" dur="3s" repeatCount="indefinite"/></circle>
<circle cx="370" cy="130" r="2" fill="#34d399"><animate attributeName="opacity" values=".3;.8;.3" dur="2.5s" begin=".6s" repeatCount="indefinite"/></circle>
<circle cx="200" cy="22" r="2" fill="#10b981"><animate attributeName="opacity" values=".2;.7;.2" dur="2s" begin="1s" repeatCount="indefinite"/></circle>
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#10b981" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#10b981" text-anchor="middle" letter-spacing=".08em">AI IMAGE GEN · TOP 2026</text>
</svg>`,

'crm-software-compared-2026': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
<defs><filter id="gl-${i}"><feGaussianBlur stdDeviation="3" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
<circle cx="200" cy="80" r="18" fill="rgba(16,185,129,.15)" stroke="#10b981" stroke-width="2" filter="url(#gl-${i})"><animate attributeName="r" values="18;22;18" dur="2.5s" repeatCount="indefinite"/></circle>
<text x="200" y="84" font-family="Space Mono,monospace" font-size="8" fill="#10b981" text-anchor="middle">CRM</text>
<circle cx="100" cy="50" r="12" fill="rgba(52,211,153,.1)" stroke="#34d399" stroke-width="1.5"/><text x="100" y="54" font-family="Space Mono,monospace" font-size="7" fill="#34d399" text-anchor="middle">👤</text>
<circle cx="300" cy="50" r="12" fill="rgba(52,211,153,.1)" stroke="#34d399" stroke-width="1.5"/><text x="300" y="54" font-family="Space Mono,monospace" font-size="7" fill="#34d399" text-anchor="middle">👤</text>
<circle cx="80" cy="115" r="12" fill="rgba(16,185,129,.1)" stroke="#10b981" stroke-width="1.5"/><text x="80" y="119" font-family="Space Mono,monospace" font-size="7" fill="#10b981" text-anchor="middle">👤</text>
<circle cx="320" cy="115" r="12" fill="rgba(16,185,129,.1)" stroke="#10b981" stroke-width="1.5"/><text x="320" y="119" font-family="Space Mono,monospace" font-size="7" fill="#10b981" text-anchor="middle">👤</text>
<line x1="112" y1="55" x2="183" y2="73" stroke="#34d399" stroke-width="1" stroke-dasharray="4,3"><animate attributeName="opacity" values=".4;.9;.4" dur="2s" repeatCount="indefinite"/></line>
<line x1="288" y1="55" x2="217" y2="73" stroke="#34d399" stroke-width="1" stroke-dasharray="4,3"><animate attributeName="opacity" values=".4;.9;.4" dur="2s" begin=".5s" repeatCount="indefinite"/></line>
<line x1="92" y1="107" x2="183" y2="90" stroke="#10b981" stroke-width="1" stroke-dasharray="4,3"><animate attributeName="opacity" values=".4;.9;.4" dur="2s" begin="1s" repeatCount="indefinite"/></line>
<line x1="308" y1="107" x2="217" y2="90" stroke="#10b981" stroke-width="1" stroke-dasharray="4,3"><animate attributeName="opacity" values=".4;.9;.4" dur="2s" begin=".3s" repeatCount="indefinite"/></line>
<circle cx="25" cy="80" r="2" fill="#10b981"><animate attributeName="opacity" values=".3;.8;.3" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="375" cy="30" r="2" fill="#34d399"><animate attributeName="opacity" values=".2;.7;.2" dur="3s" begin=".5s" repeatCount="indefinite"/></circle>
<circle cx="200" cy="150" r="2" fill="#10b981"><animate attributeName="opacity" values=".3;.6;.3" dur="2.5s" begin="1s" repeatCount="indefinite"/></circle>
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#10b981" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#10b981" text-anchor="middle" letter-spacing=".08em">CRM · COMPARED · 2026</text>
</svg>`,

'best-email-marketing-2026': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
<defs><filter id="gl-${i}"><feGaussianBlur stdDeviation="3" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
<rect x="130" y="45" width="140" height="95" rx="6" fill="rgba(16,185,129,.07)" stroke="#10b981" stroke-width="1.5"/>
<polyline points="130,55 200,95 270,55" fill="none" stroke="#10b981" stroke-width="1.5"/>
<line x1="130" y1="55" x2="130" y2="140" stroke="#10b981" stroke-width="1" opacity=".5"/>
<line x1="270" y1="55" x2="270" y2="140" stroke="#10b981" stroke-width="1" opacity=".5"/>
<line x1="130" y1="140" x2="270" y2="140" stroke="#10b981" stroke-width="1" opacity=".5"/>
<path d="M145,70 Q200,110 255,70" fill="none" stroke="#34d399" stroke-width="1.5" opacity=".5"><animate attributeName="d" values="M145,70 Q200,110 255,70;M145,60 Q200,100 255,60;M145,70 Q200,110 255,70" dur="3s" repeatCount="indefinite"/></path>
<text x="320" y="60" font-family="Space Mono,monospace" font-size="22" fill="#10b981" text-anchor="middle" opacity=".7" filter="url(#gl-${i})">@<animate attributeName="y" values="60;50;60" dur="2.5s" repeatCount="indefinite"/><animate attributeName="opacity" values=".7;1;.7" dur="2.5s" repeatCount="indefinite"/></text>
<text x="75" y="80" font-family="Space Mono,monospace" font-size="16" fill="#34d399" text-anchor="middle" opacity=".5"><animate attributeName="opacity" values=".5;.9;.5" dur="2s" begin=".8s" repeatCount="indefinite"/>@</text>
<circle cx="30" cy="50" r="2" fill="#10b981"><animate attributeName="opacity" values=".3;.8;.3" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="370" cy="130" r="2" fill="#34d399"><animate attributeName="opacity" values=".2;.7;.2" dur="3s" begin=".6s" repeatCount="indefinite"/></circle>
<circle cx="200" cy="25" r="2" fill="#10b981"><animate attributeName="opacity" values=".3;.6;.3" dur="2.5s" begin="1s" repeatCount="indefinite"/></circle>
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#10b981" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#10b981" text-anchor="middle" letter-spacing=".08em">EMAIL · MARKETING · TOP</text>
</svg>`,

'best-free-llm': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
<defs><filter id="gl-${i}"><feGaussianBlur stdDeviation="4" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
<ellipse cx="200" cy="82" rx="55" ry="42" fill="rgba(16,185,129,.06)" stroke="#10b981" stroke-width="1.5" filter="url(#gl-${i})"><animate attributeName="rx" values="55;60;55" dur="3s" repeatCount="indefinite"/></ellipse>
<line x1="145" y1="82" x2="90" y2="55" stroke="#34d399" stroke-width="1" stroke-dasharray="3,3"><animate attributeName="opacity" values=".4;.9;.4" dur="2s" repeatCount="indefinite"/></line>
<line x1="145" y1="82" x2="85" y2="108" stroke="#34d399" stroke-width="1" stroke-dasharray="3,3"><animate attributeName="opacity" values=".4;.9;.4" dur="2s" begin=".3s" repeatCount="indefinite"/></line>
<line x1="255" y1="82" x2="310" y2="55" stroke="#34d399" stroke-width="1" stroke-dasharray="3,3"><animate attributeName="opacity" values=".4;.9;.4" dur="2s" begin=".6s" repeatCount="indefinite"/></line>
<line x1="255" y1="82" x2="315" y2="108" stroke="#34d399" stroke-width="1" stroke-dasharray="3,3"><animate attributeName="opacity" values=".4;.9;.4" dur="2s" begin=".9s" repeatCount="indefinite"/></line>
<circle cx="90" cy="55" r="6" fill="rgba(52,211,153,.2)" stroke="#34d399" stroke-width="1"><animate attributeName="r" values="6;8;6" dur="2.5s" repeatCount="indefinite"/></circle>
<circle cx="85" cy="108" r="6" fill="rgba(52,211,153,.2)" stroke="#34d399" stroke-width="1"><animate attributeName="r" values="6;8;6" dur="2.5s" begin=".4s" repeatCount="indefinite"/></circle>
<circle cx="310" cy="55" r="6" fill="rgba(52,211,153,.2)" stroke="#34d399" stroke-width="1"><animate attributeName="r" values="6;8;6" dur="2.5s" begin=".8s" repeatCount="indefinite"/></circle>
<circle cx="315" cy="108" r="6" fill="rgba(52,211,153,.2)" stroke="#34d399" stroke-width="1"><animate attributeName="r" values="6;8;6" dur="2.5s" begin=".2s" repeatCount="indefinite"/></circle>
<text x="200" y="87" font-family="Space Mono,monospace" font-size="9" fill="#10b981" text-anchor="middle">BRAIN</text>
<rect x="155" y="22" width="38" height="16" rx="8" fill="#10b981" opacity=".9"><animate attributeName="opacity" values=".9;.5;.9" dur="2s" repeatCount="indefinite"/></rect>
<text x="174" y="33" font-family="Space Mono,monospace" font-size="7" fill="#0a0e1a" text-anchor="middle" font-weight="700">FREE</text>
<circle cx="25" cy="90" r="2" fill="#10b981"><animate attributeName="opacity" values=".3;.8;.3" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="375" cy="40" r="2" fill="#34d399"><animate attributeName="opacity" values=".2;.7;.2" dur="3s" begin=".5s" repeatCount="indefinite"/></circle>
<circle cx="200" cy="150" r="2" fill="#10b981"><animate attributeName="opacity" values=".3;.6;.3" dur="2.5s" begin="1s" repeatCount="indefinite"/></circle>
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#10b981" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#10b981" text-anchor="middle" letter-spacing=".08em">FREE LLM · BEST · 2026</text>
</svg>`,

'best-free-ai-coding': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
<defs><filter id="gl-${i}"><feGaussianBlur stdDeviation="2" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
<rect x="80" y="30" width="240" height="115" rx="8" fill="rgba(16,185,129,.06)" stroke="#10b981" stroke-width="1.5"/>
<rect x="80" y="30" width="240" height="20" rx="8" fill="rgba(16,185,129,.2)"/>
<text x="200" y="44" font-family="Space Mono,monospace" font-size="7" fill="#10b981" text-anchor="middle">terminal</text>
<text x="100" y="72" font-family="Space Mono,monospace" font-size="9" fill="#34d399">$&gt;</text>
<text x="118" y="72" font-family="Space Mono,monospace" font-size="9" fill="#10b981" opacity=".8">ai code</text>
<rect x="175" y="62" width="2" height="11" rx="1" fill="#10b981"><animate attributeName="opacity" values="1;0;1" dur="1s" repeatCount="indefinite"/></rect>
<text x="100" y="88" font-family="Space Mono,monospace" font-size="8" fill="#06b6d4" opacity=".7">{  }</text>
<text x="140" y="88" font-family="Space Mono,monospace" font-size="8" fill="#34d399" opacity=".6">fn main()</text>
<text x="100" y="103" font-family="Space Mono,monospace" font-size="8" fill="#a78bfa" opacity=".5">// FREE AI</text>
<text x="100" y="118" font-family="Space Mono,monospace" font-size="8" fill="#10b981" opacity=".4">return 0</text>
<text x="300" y="75" font-family="Space Mono,monospace" font-size="24" fill="#f59e0b" text-anchor="middle" filter="url(#gl-${i})" opacity=".8">⚡<animate attributeName="opacity" values=".8;.3;.8" dur="1.5s" repeatCount="indefinite"/></text>
<circle cx="25" cy="80" r="2" fill="#10b981"><animate attributeName="opacity" values=".3;.8;.3" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="375" cy="50" r="2" fill="#34d399"><animate attributeName="opacity" values=".2;.7;.2" dur="3s" begin=".5s" repeatCount="indefinite"/></circle>
<circle cx="200" cy="22" r="2" fill="#06b6d4"><animate attributeName="opacity" values=".3;.6;.3" dur="2.5s" begin="1s" repeatCount="indefinite"/></circle>
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#10b981" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#10b981" text-anchor="middle" letter-spacing=".08em">AI CODING · FREE · TOP</text>
</svg>`,

'best-free-project-management': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
<defs><filter id="gl-${i}"><feGaussianBlur stdDeviation="2" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
<rect x="40" y="30" width="80" height="115" rx="6" fill="rgba(16,185,129,.07)" stroke="#10b981" stroke-width="1.5"/>
<text x="80" y="48" font-family="Space Mono,monospace" font-size="6" fill="#10b981" text-anchor="middle">TODO</text>
<rect x="50" y="55" width="60" height="18" rx="3" fill="rgba(16,185,129,.15)" stroke="#10b981" stroke-width="1"/>
<rect x="50" y="78" width="60" height="18" rx="3" fill="rgba(16,185,129,.12)" stroke="#10b981" stroke-width="1"/>
<rect x="50" y="101" width="60" height="18" rx="3" fill="rgba(16,185,129,.1)" stroke="#10b981" stroke-width="1"/>
<rect x="160" y="30" width="80" height="115" rx="6" fill="rgba(52,211,153,.07)" stroke="#34d399" stroke-width="1.5"/>
<text x="200" y="48" font-family="Space Mono,monospace" font-size="6" fill="#34d399" text-anchor="middle">DOING</text>
<rect x="170" y="55" width="60" height="18" rx="3" fill="rgba(52,211,153,.15)" stroke="#34d399" stroke-width="1"><animate attributeName="y" values="55;73;55" dur="3s" repeatCount="indefinite"/></rect>
<rect x="280" y="30" width="80" height="115" rx="6" fill="rgba(16,185,129,.05)" stroke="#10b981" stroke-width="1.5"/>
<text x="320" y="48" font-family="Space Mono,monospace" font-size="6" fill="#10b981" text-anchor="middle">DONE</text>
<rect x="290" y="55" width="60" height="18" rx="3" fill="rgba(16,185,129,.12)" stroke="#10b981" stroke-width="1"/>
<text x="298" y="67" font-family="Space Mono,monospace" font-size="8" fill="#10b981">✓</text>
<rect x="290" y="78" width="60" height="18" rx="3" fill="rgba(16,185,129,.1)" stroke="#10b981" stroke-width="1"/>
<text x="298" y="90" font-family="Space Mono,monospace" font-size="8" fill="#10b981"><animate attributeName="opacity" values="0;1;1" dur="2.5s" repeatCount="indefinite"/>✓</text>
<circle cx="15" cy="80" r="2" fill="#10b981"><animate attributeName="opacity" values=".3;.8;.3" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="385" cy="130" r="2" fill="#34d399"><animate attributeName="opacity" values=".2;.7;.2" dur="3s" begin=".5s" repeatCount="indefinite"/></circle>
<circle cx="200" cy="20" r="2" fill="#10b981"><animate attributeName="opacity" values=".3;.6;.3" dur="2.5s" begin="1s" repeatCount="indefinite"/></circle>
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#10b981" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#10b981" text-anchor="middle" letter-spacing=".08em">PROJECT MGMT · FREE</text>
</svg>`,

'how-to-choose-ai-coding-assistant': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
<defs><filter id="gl-${i}"><feGaussianBlur stdDeviation="3" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
<circle cx="200" cy="38" r="10" fill="rgba(139,92,246,.2)" stroke="#8b5cf6" stroke-width="1.5" filter="url(#gl-${i})"><animate attributeName="r" values="10;13;10" dur="2s" repeatCount="indefinite"/></circle>
<text x="200" y="42" font-family="Space Mono,monospace" font-size="7" fill="#8b5cf6" text-anchor="middle">START</text>
<line x1="185" y1="48" x2="145" y2="72" stroke="#8b5cf6" stroke-width="1.5" stroke-dasharray="4,3"><animate attributeName="opacity" values=".5;1;.5" dur="2s" repeatCount="indefinite"/></line>
<line x1="215" y1="48" x2="255" y2="72" stroke="#a78bfa" stroke-width="1.5" stroke-dasharray="4,3"><animate attributeName="opacity" values=".5;1;.5" dur="2s" begin=".5s" repeatCount="indefinite"/></line>
<circle cx="135" cy="78" r="9" fill="rgba(139,92,246,.15)" stroke="#8b5cf6" stroke-width="1.2"><animate attributeName="r" values="9;12;9" dur="2.5s" begin=".3s" repeatCount="indefinite"/></circle>
<text x="135" y="81" font-family="Space Mono,monospace" font-size="5.5" fill="#8b5cf6" text-anchor="middle">Budget?</text>
<circle cx="265" cy="78" r="9" fill="rgba(167,139,250,.15)" stroke="#a78bfa" stroke-width="1.2"><animate attributeName="r" values="9;12;9" dur="2.5s" begin=".8s" repeatCount="indefinite"/></circle>
<text x="265" y="81" font-family="Space Mono,monospace" font-size="5.5" fill="#a78bfa" text-anchor="middle">Stack?</text>
<line x1="126" y1="87" x2="95" y2="108" stroke="#8b5cf6" stroke-width="1.2" stroke-dasharray="3,3"/>
<line x1="144" y1="87" x2="175" y2="108" stroke="#8b5cf6" stroke-width="1.2" stroke-dasharray="3,3"/>
<line x1="256" y1="87" x2="225" y2="108" stroke="#a78bfa" stroke-width="1.2" stroke-dasharray="3,3"/>
<line x1="274" y1="87" x2="305" y2="108" stroke="#a78bfa" stroke-width="1.2" stroke-dasharray="3,3"/>
<rect x="78" y="108" width="36" height="16" rx="6" fill="rgba(139,92,246,.2)" stroke="#8b5cf6" stroke-width="1"><animate attributeName="opacity" values=".7;1;.7" dur="3s" repeatCount="indefinite"/></rect>
<text x="96" y="119" font-family="Space Mono,monospace" font-size="5" fill="#8b5cf6" text-anchor="middle">Free</text>
<rect x="158" y="108" width="36" height="16" rx="6" fill="rgba(139,92,246,.2)" stroke="#8b5cf6" stroke-width="1"><animate attributeName="opacity" values=".7;1;.7" dur="3s" begin=".5s" repeatCount="indefinite"/></rect>
<text x="176" y="119" font-family="Space Mono,monospace" font-size="5" fill="#8b5cf6" text-anchor="middle">Pro</text>
<rect x="207" y="108" width="36" height="16" rx="6" fill="rgba(167,139,250,.2)" stroke="#a78bfa" stroke-width="1"><animate attributeName="opacity" values=".7;1;.7" dur="3s" begin="1s" repeatCount="indefinite"/></rect>
<text x="225" y="119" font-family="Space Mono,monospace" font-size="5" fill="#a78bfa" text-anchor="middle">Web</text>
<rect x="287" y="108" width="36" height="16" rx="6" fill="rgba(167,139,250,.2)" stroke="#a78bfa" stroke-width="1"><animate attributeName="opacity" values=".7;1;.7" dur="3s" begin="1.5s" repeatCount="indefinite"/></rect>
<text x="305" y="119" font-family="Space Mono,monospace" font-size="5" fill="#a78bfa" text-anchor="middle">VS</text>
<circle cx="25" cy="50" r="2" fill="#8b5cf6"><animate attributeName="opacity" values=".3;.8;.3" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="375" cy="100" r="2" fill="#a78bfa"><animate attributeName="opacity" values=".2;.7;.2" dur="3s" begin=".5s" repeatCount="indefinite"/></circle>
<circle cx="200" cy="148" r="2" fill="#8b5cf6"><animate attributeName="opacity" values=".3;.6;.3" dur="2.5s" begin="1s" repeatCount="indefinite"/></circle>
<rect x="90" y="157" width="220" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#8b5cf6" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#8b5cf6" text-anchor="middle" letter-spacing=".08em">CHOOSE · AI CODING · GUIDE</text>
</svg>`,

'llm-api-integration-guide': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
...
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#8b5cf6" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#8b5cf6" text-anchor="middle" letter-spacing=".08em">LLM API · INTEGRATION</text>
</svg>`,

'free-ai-tools-startups-2026': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
<defs><linearGradient id="g-${i}" x1="0%" y1="100%" x2="0%" y2="0%"><stop offset="0%" stop-color="#8b5cf6"/><stop offset="100%" stop-color="#a78bfa"/></linearGradient><filter id="gl-${i}"><feGaussianBlur stdDeviation="4" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
<polygon points="200,25 215,75 200,65 185,75" fill="url(#g-${i})" filter="url(#gl-${i})"><animate attributeName="points" values="200,25 215,75 200,65 185,75;200,15 215,70 200,60 185,70;200,25 215,75 200,65 185,75" dur="3s" repeatCount="indefinite"/></polygon>
<path d="M185,75 Q170,90 165,110 L200,100 L235,110 Q230,90 215,75Z" fill="rgba(139,92,246,.3)"/>
<line x1="200" y1="100" x2="200" y2="140" stroke="url(#g-${i})" stroke-width="2" opacity=".5"/>
<circle cx="200" cy="100" r="3" fill="#a78bfa"><animate attributeName="cy" values="100;130;100" dur="2s" repeatCount="indefinite"/><animate attributeName="opacity" values="1;0;1" dur="2s" repeatCount="indefinite"/></circle>
<text x="80" y="55" font-family="Space Mono,monospace" font-size="10" fill="#a78bfa" opacity=".4"><animate attributeName="opacity" values=".4;.9;.4" dur="2.5s" repeatCount="indefinite"/>✦</text>
<text x="310" y="45" font-family="Space Mono,monospace" font-size="8" fill="#8b5cf6" opacity=".5"><animate attributeName="opacity" values=".5;1;.5" dur="3s" begin=".4s" repeatCount="indefinite"/>★</text>
<text x="60" y="100" font-family="Space Mono,monospace" font-size="6" fill="#a78bfa" opacity=".3"><animate attributeName="opacity" values=".3;.7;.3" dur="2s" begin=".8s" repeatCount="indefinite"/>★</text>
<text x="330" y="90" font-family="Space Mono,monospace" font-size="9" fill="#8b5cf6" opacity=".4"><animate attributeName="opacity" values=".4;.8;.4" dur="3.5s" begin="1.2s" repeatCount="indefinite"/>✦</text>
<text x="350" y="50" font-family="Space Mono,monospace" font-size="7" fill="#a78bfa" opacity=".3"><animate attributeName="opacity" values=".3;.7;.3" dur="2.8s" begin=".6s" repeatCount="indefinite"/>★</text>
<circle cx="30" cy="70" r="2" fill="#8b5cf6"><animate attributeName="opacity" values=".3;.8;.3" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="370" cy="120" r="2" fill="#a78bfa"><animate attributeName="opacity" values=".2;.7;.2" dur="3s" begin=".5s" repeatCount="indefinite"/></circle>
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#8b5cf6" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#8b5cf6" text-anchor="middle" letter-spacing=".08em">STARTUPS · AI TOOLS · FREE</text>
</svg>`,

'ai-pricing-pages-guide': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
<defs><filter id="gl-${i}"><feGaussianBlur stdDeviation="3" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
<rect x="50" y="35" width="120" height="100" rx="5" fill="rgba(139,92,246,.06)" stroke="#8b5cf6" stroke-width="1.5"/>
<text x="110" y="52" font-family="Space Mono,monospace" font-size="6" fill="#8b5cf6" text-anchor="middle">STARTER</text>
<text x="110" y="68" font-family="Space Mono,monospace" font-size="11" fill="#8b5cf6" text-anchor="middle" font-weight="700">$9</text>
<rect x="65" y="75" width="90" height="4" rx="2" fill="#8b5cf6" opacity=".3"/>
<rect x="65" y="84" width="70" height="4" rx="2" fill="#8b5cf6" opacity=".2"/>
<rect x="65" y="93" width="80" height="4" rx="2" fill="#8b5cf6" opacity=".25"/>
<rect x="230" y="35" width="120" height="100" rx="5" fill="rgba(167,139,250,.08)" stroke="#a78bfa" stroke-width="1.5"/>
<text x="290" y="52" font-family="Space Mono,monospace" font-size="6" fill="#a78bfa" text-anchor="middle">PRO</text>
<text x="290" y="68" font-family="Space Mono,monospace" font-size="11" fill="#a78bfa" text-anchor="middle" font-weight="700">$49</text>
<rect x="245" y="75" width="90" height="4" rx="2" fill="#a78bfa" opacity=".3"/>
<rect x="245" y="84" width="75" height="4" rx="2" fill="#a78bfa" opacity=".25"/>
<rect x="245" y="93" width="85" height="4" rx="2" fill="#a78bfa" opacity=".2"/>
<circle cx="200" cy="85" r="16" fill="rgba(16,185,129,.1)" stroke="#10b981" stroke-width="1.5" filter="url(#gl-${i})"><animate attributeName="r" values="16;20;16" dur="2.5s" repeatCount="indefinite"/></circle>
<text x="200" y="89" font-family="Space Mono,monospace" font-size="8" fill="#10b981" text-anchor="middle">🔍</text>
<circle cx="25" cy="80" r="2" fill="#8b5cf6"><animate attributeName="opacity" values=".3;.8;.3" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="375" cy="50" r="2" fill="#a78bfa"><animate attributeName="opacity" values=".2;.7;.2" dur="3s" begin=".5s" repeatCount="indefinite"/></circle>
<circle cx="200" cy="150" r="2" fill="#8b5cf6"><animate attributeName="opacity" values=".3;.6;.3" dur="2.5s" begin="1s" repeatCount="indefinite"/></circle>
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#8b5cf6" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#8b5cf6" text-anchor="middle" letter-spacing=".08em">PRICING · PAGES · GUIDE</text>
</svg>`,

'ai-tools-market-2026-analysis': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
<defs><linearGradient id="g-${i}" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#f59e0b"/><stop offset="100%" stop-color="#fbbf24"/></linearGradient><filter id="gl-${i}"><feGaussianBlur stdDeviation="3" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
<path d="M160,80 L200,80 L200,40 A40,40 0 0,1 234,100Z" fill="rgba(245,158,11,.2)" stroke="#f59e0b" stroke-width="1.5"><animate attributeName="opacity" values=".8;1;.8" dur="2s" repeatCount="indefinite"/></path>
<path d="M160,80 L200,80 L234,100 A40,40 0 0,1 160,80Z" fill="rgba(251,191,36,.15)" stroke="#fbbf24" stroke-width="1.5"><animate attributeName="opacity" values=".8;1;.8" dur="2.5s" begin=".4s" repeatCount="indefinite"/></path>
<path d="M160,80 L200,80 A40,40 0 0,1 160,80Z" fill="rgba(245,158,11,.1)" stroke="#f59e0b" stroke-width="1"/>
<rect x="50" y="100" width="20" height="35" rx="3" fill="rgba(245,158,11,.2)" stroke="#f59e0b" stroke-width="1"><animate attributeName="height" values="35;42;35" dur="2s" repeatCount="indefinite"/><animate attributeName="y" values="100;93;100" dur="2s" repeatCount="indefinite"/></rect>
<rect x="78" y="85" width="20" height="50" rx="3" fill="rgba(251,191,36,.2)" stroke="#fbbf24" stroke-width="1"><animate attributeName="height" values="50;58;50" dur="2.5s" begin=".3s" repeatCount="indefinite"/><animate attributeName="y" values="85;77;85" dur="2.5s" begin=".3s" repeatCount="indefinite"/></rect>
<rect x="106" y="70" width="20" height="65" rx="3" fill="rgba(245,158,11,.18)" stroke="#f59e0b" stroke-width="1"><animate attributeName="height" values="65;73;65" dur="2s" begin=".6s" repeatCount="indefinite"/><animate attributeName="y" values="70;62;70" dur="2s" begin=".6s" repeatCount="indefinite"/></rect>
<polyline points="280,130 300,110 320,95 340,80 360,55 380,40" fill="none" stroke="url(#g-${i})" stroke-width="2.5" filter="url(#gl-${i})"><animate attributeName="stroke-dasharray" values="0,300;300,0" dur="3s" repeatCount="indefinite"/></polyline>
<circle cx="360" cy="55" r="5" fill="#f59e0b"><animate attributeName="r" values="5;8;5" dur="2s" repeatCount="indefinite"/></circle>
<text x="200" y="25" font-family="Space Mono,monospace" font-size="8" fill="#f59e0b" text-anchor="middle" opacity=".6">331 tools</text>
<circle cx="25" cy="60" r="2" fill="#f59e0b"><animate attributeName="opacity" values=".3;.8;.3" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="375" cy="150" r="2" fill="#fbbf24"><animate attributeName="opacity" values=".2;.7;.2" dur="3s" begin=".5s" repeatCount="indefinite"/></circle>
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#f59e0b" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#f59e0b" text-anchor="middle" letter-spacing=".08em">AI MARKET · 331 TOOLS</text>
</svg>`,

'real-cost-ai-2026': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
<defs><filter id="gl-${i}"><feGaussianBlur stdDeviation="3" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
<ellipse cx="120" cy="125" rx="40" ry="8" fill="rgba(245,158,11,.15)" stroke="#f59e0b" stroke-width="1"/>
<rect x="90" y="80" width="60" height="45" rx="4" fill="rgba(245,158,11,.1)" stroke="#f59e0b" stroke-width="1.5"/>
<ellipse cx="120" cy="80" rx="30" ry="7" fill="rgba(251,191,36,.2)" stroke="#fbbf24" stroke-width="1.5"/>
<ellipse cx="120" cy="60" rx="30" ry="7" fill="rgba(245,158,11,.15)" stroke="#f59e0b" stroke-width="1.5"/>
<ellipse cx="120" cy="40" rx="30" ry="7" fill="rgba(251,191,36,.2)" stroke="#fbbf24" stroke-width="1.5"><animate attributeName="ry" values="7;9;7" dur="2s" repeatCount="indefinite"/></ellipse>
<text x="120" y="44" font-family="Space Mono,monospace" font-size="8" fill="#fbbf24" text-anchor="middle">$$$</text>
<rect x="240" y="50" width="100" height="85" rx="6" fill="rgba(245,158,11,.07)" stroke="#f59e0b" stroke-width="1.5" filter="url(#gl-${i})"/>
<text x="290" y="68" font-family="Space Mono,monospace" font-size="7" fill="#f59e0b" text-anchor="middle">CALC</text>
<text x="290" y="88" font-family="Space Mono,monospace" font-size="10" fill="#fbbf24" text-anchor="middle"><animate attributeName="textContent" values="$1.2K;$0.8K;$3.4K;$1.2K" dur="4s" repeatCount="indefinite">$1.2K</animate></text>
<rect x="252" y="95" width="76" height="1.5" fill="#f59e0b" opacity=".4"/>
<text x="290" y="108" font-family="Space Mono,monospace" font-size="6" fill="#f59e0b" text-anchor="middle" opacity=".6">/month</text>
<polyline points="245,120 260,115 275,125 290,108 305,118 320,105 335,112" fill="none" stroke="#f59e0b" stroke-width="1.5"><animate attributeName="points" values="245,120 260,115 275,125 290,108 305,118 320,105 335,112;245,115 260,108 275,118 290,100 305,112 320,98 335,108;245,120 260,115 275,125 290,108 305,118 320,105 335,112" dur="3s" repeatCount="indefinite"/></polyline>
<circle cx="20" cy="80" r="2" fill="#f59e0b"><animate attributeName="opacity" values=".3;.8;.3" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="380" cy="30" r="2" fill="#fbbf24"><animate attributeName="opacity" values=".2;.7;.2" dur="3s" begin=".5s" repeatCount="indefinite"/></circle>
<circle cx="200" cy="145" r="2" fill="#f59e0b"><animate attributeName="opacity" values=".3;.6;.3" dur="2.5s" begin="1s" repeatCount="indefinite"/></circle>
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#f59e0b" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#f59e0b" text-anchor="middle" letter-spacing=".08em">REAL COST · AI · 2026</text>
</svg>`,

'highest-rated-ai-tools-2026': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
<defs><filter id="gl-${i}"><feGaussianBlur stdDeviation="4" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
<text x="60" y="82" font-family="Space Mono,monospace" font-size="24" fill="#f59e0b" text-anchor="middle" filter="url(#gl-${i})">★<animate attributeName="opacity" values="0;1;1;1" dur="3s" repeatCount="indefinite"/></text>
<text x="110" y="82" font-family="Space Mono,monospace" font-size="24" fill="#f59e0b" text-anchor="middle" filter="url(#gl-${i})">★<animate attributeName="opacity" values="0;0;1;1" dur="3s" begin=".4s" repeatCount="indefinite"/></text>
<text x="160" y="82" font-family="Space Mono,monospace" font-size="24" fill="#f59e0b" text-anchor="middle" filter="url(#gl-${i})">★<animate attributeName="opacity" values="0;0;0;1" dur="3s" begin=".8s" repeatCount="indefinite"/></text>
<text x="210" y="82" font-family="Space Mono,monospace" font-size="24" fill="#fbbf24" text-anchor="middle" filter="url(#gl-${i})">★<animate attributeName="opacity" values="0;0;0;1" dur="3s" begin="1.2s" repeatCount="indefinite"/></text>
<text x="260" y="82" font-family="Space Mono,monospace" font-size="24" fill="#fbbf24" text-anchor="middle" filter="url(#gl-${i})">★<animate attributeName="opacity" values="0;0;0;1" dur="3s" begin="1.6s" repeatCount="indefinite"/></text>
<path d="M300,30 L310,55 L340,55 L315,72 L325,97 L300,80 L275,97 L285,72 L260,55 L290,55Z" fill="rgba(245,158,11,.15)" stroke="#f59e0b" stroke-width="1.5" filter="url(#gl-${i})"><animate attributeName="opacity" values=".6;1;.6" dur="2s" repeatCount="indefinite"/></path>
<text x="300" y="67" font-family="Space Mono,monospace" font-size="7" fill="#fbbf24" text-anchor="middle">TOP</text>
<circle cx="25" cy="50" r="2" fill="#f59e0b"><animate attributeName="opacity" values=".3;.8;.3" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="375" cy="120" r="2" fill="#fbbf24"><animate attributeName="opacity" values=".2;.7;.2" dur="3s" begin=".5s" repeatCount="indefinite"/></circle>
<text x="50" y="115" font-family="Space Mono,monospace" font-size="7" fill="#f59e0b" opacity=".3"><animate attributeName="opacity" values=".3;.6;.3" dur="2.5s" repeatCount="indefinite"/>✦</text>
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#f59e0b" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#f59e0b" text-anchor="middle" letter-spacing=".08em">TOP RATED · AI · 2026</text>
</svg>`,

'open-source-vs-proprietary-llms': `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
<defs><filter id="gl-${i}"><feGaussianBlur stdDeviation="3" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
<rect x="0" y="0" width="195" height="180" fill="rgba(245,158,11,.02)"/>
<rect x="205" y="0" width="195" height="180" fill="rgba(100,116,139,.02)"/>
<line x1="200" y1="0" x2="200" y2="180" stroke="#334155" stroke-width="1" stroke-dasharray="4,4"/>
<rect x="135" y="60" width="34" height="28" rx="4" fill="none" stroke="#f59e0b" stroke-width="2"/>
<circle cx="152" cy="72" r="3" fill="#f59e0b" opacity=".8"/>
<path d="M143,65 L143,55 Q143,45 152,45 Q161,45 161,55 L161,65" fill="none" stroke="#f59e0b" stroke-width="2"><animate attributeName="d" values="M143,65 L143,55 Q143,45 152,45 Q161,45 161,55 L161,65;M143,65 L143,60 Q143,50 152,50 Q161,50 161,60 L161,65;M143,65 L143,55 Q143,45 152,45 Q161,45 161,55 L161,65" dur="3s" repeatCount="indefinite"/></path>
<text x="120" y="105" font-family="Space Mono,monospace" font-size="7" fill="#f59e0b" text-anchor="middle">{  }</text>
<text x="70" y="65" font-family="Space Mono,monospace" font-size="7" fill="#f59e0b" opacity=".6">open</text>
<text x="60" y="80" font-family="Space Mono,monospace" font-size="6" fill="#f59e0b" opacity=".4">Llama</text>
<text x="55" y="93" font-family="Space Mono,monospace" font-size="6" fill="#f59e0b" opacity=".35">Mistral</text>
<rect x="231" y="55" width="34" height="32" rx="4" fill="none" stroke="#64748b" stroke-width="2"/>
<rect x="237" y="70" width="6" height="12" rx="2" fill="#64748b" opacity=".7"/>
<rect x="247" y="70" width="6" height="12" rx="2" fill="#64748b" opacity=".7"/>
<rect x="257" y="70" width="6" height="12" rx="2" fill="#64748b" opacity=".7"/>
<path d="M231,63 Q231,55 248,55 Q265,55 265,63" fill="rgba(100,116,139,.2)" stroke="#64748b" stroke-width="1.5"/>
<text x="280" y="65" font-family="Space Mono,monospace" font-size="7" fill="#64748b" opacity=".6">closed</text>
<text x="280" y="80" font-family="Space Mono,monospace" font-size="6" fill="#64748b" opacity=".4">GPT-4</text>
<text x="285" y="93" font-family="Space Mono,monospace" font-size="6" fill="#64748b" opacity=".35">Claude</text>
<text x="200" y="45" font-family="Space Mono,monospace" font-size="14" fill="#f59e0b" text-anchor="middle" filter="url(#gl-${i})">⚡<animate attributeName="opacity" values=".5;1;.5" dur="1.5s" repeatCount="indefinite"/></text>
<circle cx="25" cy="90" r="2" fill="#f59e0b"><animate attributeName="opacity" values=".3;.8;.3" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="375" cy="50" r="2" fill="#64748b"><animate attributeName="opacity" values=".2;.6;.2" dur="3s" begin=".5s" repeatCount="indefinite"/></circle>
<circle cx="200" cy="148" r="2" fill="#f59e0b"><animate attributeName="opacity" values=".3;.6;.3" dur="2.5s" begin="1s" repeatCount="indefinite"/></circle>
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#f59e0b" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#f59e0b" text-anchor="middle" letter-spacing=".08em">OPEN · VS · PROPRIETARY</text>
</svg>`

  };
  return svgs[slug] || `<svg viewBox="0 0 400 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
<rect width="400" height="180" fill="#0a0e1a"/>
<defs><linearGradient id="g-${i}" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#3b82f6"/><stop offset="100%" stop-color="#06b6d4"/></linearGradient></defs>
<circle cx="200" cy="85" r="40" fill="rgba(59,130,246,.1)" stroke="#3b82f6" stroke-width="1.5"><animate attributeName="r" values="40;45;40" dur="3s" repeatCount="indefinite"/></circle>
<text x="200" y="90" font-family="Space Mono,monospace" font-size="10" fill="#3b82f6" text-anchor="middle">AI</text>
<circle cx="50" cy="50" r="2" fill="#3b82f6"><animate attributeName="opacity" values=".3;.8;.3" dur="2s" repeatCount="indefinite"/></circle>
<circle cx="350" cy="130" r="2" fill="#06b6d4"><animate attributeName="opacity" values=".2;.7;.2" dur="3s" begin=".5s" repeatCount="indefinite"/></circle>
<rect x="100" y="157" width="200" height="18" rx="9" fill="rgba(10,14,26,.85)" stroke="#3b82f6" stroke-width="1"/>
<text x="200" y="169" font-family="Space Mono,monospace" font-size="6" fill="#3b82f6" text-anchor="middle" letter-spacing=".08em">COMPAREDGE · 2026</text>
</svg>`;
}
...
function generateIndex(articles) {
  ...
  <div class="card-img" style="background:${meta.bg}">${cardHeaderSVG(a.slug, ci)}</div>
  <div class="card-body">
...
<!-- ── ARTICLES GRID ── -->
<div class="container" id="articles" style="padding-top:40px">
  <div class="hero-stats-bar" style="margin-bottom:36px">
